...
export const onnx = $root.onnx = (() => {
    ...
    onnx.ModelProto = (function() {
        ...
        ModelProto.verify = function verify(message) {
            ...
            if (message.opsetImport != null && message.hasOwnProperty("opsetImport")) {
                ...
                for (let i = 0; i < message.opsetImport.length; ++i) {
                    let error = $root.onnx.OperatorSetIdProto.verify(message.opsetImport[i]);
                    if (error)
            ...
            if (message.metadataProps != null && message.hasOwnProperty("metadataProps")) {
                ...
                for (let i = 0; i < message.metadataProps.length; ++i) {
                    let error = $root.onnx.StringStringEntryProto.verify(message.metadataProps[i]);
                    if (error)
    ...
    onnx.TensorAnnotation = (function() {
        ...
        TensorAnnotation.verify = function verify(message) {
            ...
            if (message.quantParameterTensorNames != null && message.hasOwnProperty("quantParameterTensorNames")) {
                ...
                for (let i = 0; i < message.quantParameterTensorNames.length; ++i) {
                    let error = $root.onnx.StringStringEntryProto.verify(message.quantParameterTensorNames[i]);
                    if (error)
    ...
    onnx.GraphProto = (function() {
        ...
        GraphProto.verify = function verify(message) {
            ...
            if (message.valueInfo != null && message.hasOwnProperty("valueInfo")) {
                ...
                for (let i = 0; i < message.valueInfo.length; ++i) {
                    let error = $root.onnx.ValueInfoProto.verify(message.valueInfo[i]);
                    if (error)
            ...
            if (message.quantizationAnnotation != null && message.hasOwnProperty("quantizationAnnotation")) {
                ...
                for (let i = 0; i < message.quantizationAnnotation.length; ++i) {
                    let error = $root.onnx.TensorAnnotation.verify(message.quantizationAnnotation[i]);
                    if (error)
    ...
    onnx.TensorProto = (function() {
        ...
        TensorProto.verify = function verify(message) {
            ...
            if (message.externalData != null && message.hasOwnProperty("externalData")) {
                ...
                for (let i = 0; i < message.externalData.length; ++i) {
                    let error = $root.onnx.StringStringEntryProto.verify(message.externalData[i]);
                    if (error)
    ...
    onnx.TypeProto = (function() {
        ...
        TypeProto.verify = function verify(message) {
            ...
            if (message.tensorType != null && message.hasOwnProperty("tensorType")) {
                properties.value = 1;
                {
                    let error = $root.onnx.TypeProto.Tensor.verify(message.tensorType);
                    if (error)
    ...
    onnx.OperatorProto = (function() {
        ...
        OperatorProto.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.onnx.OperatorProto();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        OperatorProto.fromObject = function fromObject(object) {
            if (object instanceof $root.onnx.OperatorProto)
                return object;
            let message = new $root.onnx.OperatorProto();
            if (object.opType != null)
                message.opType = String(object.opType);
            if (object.sinceVersion != null)
                if ($util.Long)
    ...
    onnx.OperatorSetProto = (function() {
         ...
         * @property {number|Long|null} [irVersion] OperatorSetProto irVersion
         ...
         * @instance
         */
        OperatorSetProto.prototype.irVersion = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        OperatorSetProto.encode = function encode(message, writer) {
            ...
            if (message.irVersion != null && message.hasOwnProperty("irVersion"))
                writer.uint32(/* id 2, wireType 0 =*/16).int64(message.irVersion);
            ...
            if (message.operator != null && message.operator.length)
                for (let i = 0; i < message.operator.length; ++i)
        ...
        OperatorSetProto.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.onnx.OperatorSetProto();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        OperatorSetProto.verify = function verify(message) {
            ...
            if (message.operator != null && message.hasOwnProperty("operator")) {
                ...
                for (let i = 0; i < message.operator.length; ++i) {
                    let error = $root.onnx.OperatorProto.verify(message.operator[i]);
                    if (error)
        ...
        OperatorSetProto.fromObject = function fromObject(object) {
            if (object instanceof $root.onnx.OperatorSetProto)
                return object;
            let message = new $root.onnx.OperatorSetProto();
            ...
            if (object.operator) {
                ...
                message.operator = [];
                for (let i = 0; i < object.operator.length; ++i) {
        ...
        OperatorSetProto.toObject = function toObject(message, options) {
            ...
            if (message.operator && message.operator.length) {
                object.operator = [];
                for (let j = 0; j < message.operator.length; ++j)
