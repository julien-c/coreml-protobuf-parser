...
export namespace onnx {
    ...
    interface IFunctionProto {
        ...
        sinceVersion?: (number|Long|null);

        /** FunctionProto status */
        status?: (onnx.OperatorStatus|null);
    ...
    class FunctionProto implements IFunctionProto {
        ...
        /** FunctionProto sinceVersion. */
        public sinceVersion: (number|Long);

        /** FunctionProto status. */
        public status: onnx.OperatorStatus;
    ...
    /** Represents an OperatorProto. */
    class OperatorProto implements IOperatorProto {

        /**
         * Constructs a new OperatorProto.
         * @param [properties] Properties to set
         */
        constructor(properties?: onnx.IOperatorProto);
         ...
         * @param [properties] Properties to set
         * @returns OperatorProto instance
         */
        public static create(properties?: onnx.IOperatorProto): onnx.OperatorProto;

        /**
         * Encodes the specified OperatorProto message. Does not implicitly {@link onnx.OperatorProto.verify|verify} messages.
         * @param message OperatorProto message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: onnx.IOperatorProto, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: onnx.IOperatorProto, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes an OperatorProto message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns OperatorProto
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): onnx.OperatorProto;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): onnx.OperatorProto;
         ...
         * @returns OperatorProto
         */
        public static fromObject(object: { [k: string]: any }): onnx.OperatorProto;

        /**
         * Creates a plain object from an OperatorProto message. Also converts values to other types if specified.
         * @param message OperatorProto
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: onnx.OperatorProto, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    interface IOperatorSetProto {
        ...
        irVersionPrerelease?: (string|null);

        /** OperatorSetProto irBuildMetadata */
        irBuildMetadata?: (string|null);

        /** OperatorSetProto domain */
        domain?: (string|null);

        /** OperatorSetProto opsetVersion */
        opsetVersion?: (number|Long|null);

        /** OperatorSetProto docString */
        docString?: (string|null);

        /** OperatorSetProto operator */
        operator?: (onnx.IOperatorProto[]|null);

        /** OperatorSetProto functions */
        functions?: (onnx.IFunctionProto[]|null);
    }

    /** Represents an OperatorSetProto. */
    class OperatorSetProto implements IOperatorSetProto {

        /**
         * Constructs a new OperatorSetProto.
         * @param [properties] Properties to set
         */
        constructor(properties?: onnx.IOperatorSetProto);
        ...
        /** OperatorSetProto irVersionPrerelease. */
        public irVersionPrerelease: string;

        /** OperatorSetProto irBuildMetadata. */
        public irBuildMetadata: string;

        /** OperatorSetProto domain. */
        public domain: string;

        /** OperatorSetProto opsetVersion. */
        public opsetVersion: (number|Long);

        /** OperatorSetProto docString. */
        public docString: string;

        /** OperatorSetProto operator. */
        public operator: onnx.IOperatorProto[];
         ...
         * @param [properties] Properties to set
         * @returns OperatorSetProto instance
         */
        public static create(properties?: onnx.IOperatorSetProto): onnx.OperatorSetProto;

        /**
         * Encodes the specified OperatorSetProto message. Does not implicitly {@link onnx.OperatorSetProto.verify|verify} messages.
         * @param message OperatorSetProto message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: onnx.IOperatorSetProto, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: onnx.IOperatorSetProto, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes an OperatorSetProto message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns OperatorSetProto
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): onnx.OperatorSetProto;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): onnx.OperatorSetProto;
         ...
         * @returns OperatorSetProto
         */
        public static fromObject(object: { [k: string]: any }): onnx.OperatorSetProto;

        /**
         * Creates a plain object from an OperatorSetProto message. Also converts values to other types if specified.
         * @param message OperatorSetProto
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: onnx.OperatorSetProto, options?: $protobuf.IConversionOptions): { [k: string]: any };
